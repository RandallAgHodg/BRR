...
public sealed record UpdateHouseCommand : SendHouseProposalCommand
{
    public UpdateHouseCommand(int id, string title, string address, decimal area, decimal price
